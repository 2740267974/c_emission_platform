...
import 'package:CEP/beans/system_option_new_g_bean.dart';
...
class SysOptionSettingPage8 extends StatelessWidget {
  ...
  const SysOptionSettingPage8({super.key});
...
class _MySysOptionSettingState extends State<MySysOptionSettingPage> {
  final List<String> options= coolClinker;
  ...
  void initState() {
    ...
    _controlers = List.generate(10, (_) => TextEditingController());
    systemOptionBean7  =
        DataProvider.getInstance()?.systemOptionBean7;
    if(systemOptionBean7 != null){
      _controlers[0].text =
      systemOptionBean7 ?.yaoweiagowen_kw.toString() as String;
      _controlers[1].text =
      systemOptionBean7  ?.yaoweigaowen_product.toString() as String;
      _controlers[2].text =
      systemOptionBean7 ?.yici_kw.toString() as String;
      _controlers[3].text =
      systemOptionBean7 ?.yici_kw.toString() as String;
      _controlers[4].text =
      systemOptionBean7 ?.yaoweifeiqi_kw.toString() as String;
      _controlers[5].text =
      systemOptionBean7 ?.yaoweifeiqi_product.toString() as String;
      _controlers[6].text =
      systemOptionBean7 ?.lengyue_kw.toString() as String;
      _controlers[7].text =
      systemOptionBean7 ?.lengyue_product.toString() as String;
      _controlers[8].text =
      systemOptionBean7 ?.meimo_kw.toString() as String;
      _controlers[9].text =
      systemOptionBean7 ?.meimo_product.toString() as String;
    }
  }
...
void save() {
  ...
  try {
    SystemOptionBean7 systemOptionBean7 = SystemOptionBean7(
    ...
    DataProvider?.setSystemOptionBean7(systemOptionBean7);
  } catch (e) {
    // 处理异常的代码
    print('Error: $e');
  }
...
void getValue() {
  String message = (DataProvider?.getSystemOptionBean7() as SystemOptionBean7).toString();
