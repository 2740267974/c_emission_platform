...
import 'package:CEP/beans/system_option_new_d_bean.dart';
...
class SysOptionSettingPage5 extends StatelessWidget {
  ...
  const SysOptionSettingPage5({super.key});
...
class _MySysOptionSettingState extends State<MySysOptionSettingPage> {
  final List<String> options= transportWays;
  ...
  void initState() {
    ...
    _controlers = List.generate(16, (_) => TextEditingController());
    systemOptionBean4  =
        DataProvider.getInstance()?.systemOptionBean4;
    if(systemOptionBean4 != null){
      _controlers[0].text =
      systemOptionBean4 ?.qiyou_Fe.toString() as String;
      _controlers[1].text =
      systemOptionBean4  ?.qiyou_shiago.toString() as String;
      _controlers[2].text =
      systemOptionBean4 ?.qiyou_shiago.toString() as String;
      _controlers[3].text =
      systemOptionBean4 ?.qiyou_niantu.toString() as String;
      _controlers[4].text =
      systemOptionBean4 ?.qiyou_shihuishi.toString() as String;
      _controlers[5].text =
      systemOptionBean4 ?.chaiyou_Fe.toString() as String;
      _controlers[6].text =
      systemOptionBean4 ?.chaiyou_shiago.toString() as String;
      _controlers[7].text =
      systemOptionBean4 ?.chaiyou_shayan.toString() as String;
      _controlers[8].text =
      systemOptionBean4 ?.chaiyou_niantu.toString() as String;
      _controlers[9].text =
      systemOptionBean4 ?.chaiyou_shihuishi.toString() as String;
      _controlers[10].text =
      systemOptionBean4 ?.shihuishipocuiji_kw.toString() as String;
      _controlers[11].text =
      systemOptionBean4 ?.shihuishipocuiji_product.toString() as String;
      _controlers[12].text =
      systemOptionBean4 ?.shengliaomo_kw.toString() as String;
      _controlers[13].text =
      systemOptionBean4 ?.shengliaomo_product.toString() as String;
      _controlers[14].text =
      systemOptionBean4 ?.fencuiji_kw.toString() as String;
      _controlers[15].text =
      systemOptionBean4 ?.fencuiji_product.toString() as String;
    }
  }
...
void save() {
  ...
  try {
    SystemOptionBean4 systemOptionBean4 = SystemOptionBean4(
    ...
    DataProvider?.setSystemOptionBean4(systemOptionBean4);
  } catch (e) {
    // 处理异常的代码
    print('Error: $e');
  }
...
void getValue() {
  String message = (DataProvider?.getSystemOptionBean4() as SystemOptionBean4).toString();
