...
class SysOptionSettingPage extends StatelessWidget {

  //设置该页面路由名称字符串常量
  //路由是指路由器从一个接口上收到数据包，根据数据包的目的地址进行定向并转发到另一个接口的过程
  //定义一个静态常量sysOptionSettingPageRouterName，其值为字符串"/SysOptionSettingPage"
  static const sysOptionSettingPageRouterName = "/SysOptionSettingPage";
  ...
  const SysOptionSettingPage({super.key});
...
class _MySysOptionSettingState extends State<MySysOptionSettingPage> {
  ...
  void initState() {
    ...
    _controlers = List.generate(25, (_) => TextEditingController());
    systemOptionBean =
        DataProvider.getInstance()?.systemOptionBean;
    if(systemOptionBean != null){
      _controlers[0].text =
          systemOptionBean?.CO2EmissionFactorOfFuelvar1.toString() as String;
      _controlers[1].text =
      systemOptionBean?.CO2EmissionFactorOfFuelvar2.toString() as String;
      _controlers[2].text =
      systemOptionBean?.CO2EmissionFactorOfFuelvar3.toString() as String;
      _controlers[3].text =
      systemOptionBean?.CO2EmissionFactorOfFuelvar4.toString() as String;
      _controlers[4].text =
      systemOptionBean?.CO2EmissionFactorOfFuelvar5.toString() as String;
      _controlers[5].text =
      systemOptionBean?.CO2EmissionFactorOfFuelvar6.toString() as String;
      _controlers[6].text =
      systemOptionBean?.CO2EmissionFactorOfFuelvar7.toString() as String;
      _controlers[7].text =
      systemOptionBean?.ElectricityCo2EmissionFactorvar1.toString() as String;
      _controlers[8].text =
      systemOptionBean?.C_CO2_chuyureji.toString() as String;
      _controlers[9].text =
      systemOptionBean?.CshiwenCO2.toString() as String;
      _controlers[10].text =
      systemOptionBean?.CshiwenO2.toString() as String;
      _controlers[11].text =
      systemOptionBean?.Chu_lengqueji_shuliao.toString() as String;
      _controlers[12].text =
      systemOptionBean?.C_raw_450.toString() as String;
      _controlers[13].text =
      systemOptionBean?.C_raw_450_900.toString() as String;
      _controlers[14].text =
      systemOptionBean?.C_raw_900.toString() as String;
      _controlers[15].text =
      systemOptionBean?.C_H2O_450.toString() as String;
      _controlers[16].text =
      systemOptionBean?.ReferenceValuevar1.toString() as String;
      _controlers[17].text =
      systemOptionBean?.t0.toString() as String;
      _controlers[18].text =
      systemOptionBean?.T_CO2_chuyureji.toString() as String;
      _controlers[19].text =
      systemOptionBean?.T_Chu_lengqueji_shuliao.toString() as String;
      _controlers[20].text =
      systemOptionBean?.ReferenceValuevar5.toString() as String;
      _controlers[21].text =
      systemOptionBean?.ReferenceValuevar6.toString() as String;
      _controlers[22].text =
      systemOptionBean?.ReferenceValuevar7.toString() as String;
      _controlers[23].text =
      systemOptionBean?.qH2O.toString() as String;
      _controlers[24].text =
      systemOptionBean?.t.toString() as String;
    }
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              //const SizedBox：就是向下空出一条空白,20像素
              const SizedBox(
                height: 20,
              ),
...
void save() {
  ...
  try {
    SystemOptionBean systemOptionBean = SystemOptionBean(
      ...
      double.parse(_controlers[8].text),
      double.parse(_controlers[9].text),
      double.parse(_controlers[10].text),
      double.parse(_controlers[11].text),
      double.parse(_controlers[12].text),
      double.parse(_controlers[13].text),
      double.parse(_controlers[14].text),
      double.parse(_controlers[15].text),
      double.parse(_controlers[16].text),
      double.parse(_controlers[17].text),
      double.parse(_controlers[18].text),
      double.parse(_controlers[19].text),
      double.parse(_controlers[20].text),
      double.parse(_controlers[21].text),
      double.parse(_controlers[22].text),
      double.parse(_controlers[23].text),
      double.parse(_controlers[24].text),
    );
    //将其设置到DataProvider的systemOptionBean属性中。
    DataProvider?.setSystemOptionBean(systemOptionBean);
  } catch (e) {
    // 处理异常的代码
    print('Error: $e');
  }
...
void getValue() {
  String message =
  //toString()方法主要用于将对象转换为字符串形式，方便打印和显示
  //如果DataProvider不为null，则返回DataProvider的getSystemOptionBean()方法的返回值
      (DataProvider?.getSystemOptionBean() as SystemOptionBean).toString();
  //Utils类的showToast方法，将message字符串以Toast的形式显示出来。
