...
class SysOptionSettingPage4 extends StatelessWidget {
  ...
  const SysOptionSettingPage4({super.key});
...
class _MySysOptionSettingState extends State<MySysOptionSettingPage> {
  ...
  void initState() {
    ...
    systemOptionBean3  =
        DataProvider.getInstance()?.systemOptionBean3;
    if(systemOptionBean3 != null){
      _controlers[0].text =
      systemOptionBean3 ?.waterPercent0.toString() as String;
      _controlers[1].text =
      systemOptionBean3  ?.mineralContent0.toString() as String;
      _controlers[2].text =
      systemOptionBean3 ?.waterPercent1.toString() as String;
      _controlers[3].text =
      systemOptionBean3 ?.mineralContent1.toString() as String;
      _controlers[4].text =
      systemOptionBean3 ?.waterPercent2.toString() as String;
      _controlers[5].text =
      systemOptionBean3 ?.mineralContent2.toString() as String;
      _controlers[6].text =
      systemOptionBean3 ?.waterPercent3.toString() as String;
      _controlers[7].text =
      systemOptionBean3 ?.mineralContent3.toString() as String;
      _controlers[8].text =
      systemOptionBean3 ?.waterPercent4.toString() as String;
      _controlers[9].text =
      systemOptionBean3 ?.mineralContent4.toString() as String;
    }
  }
...
void save() {
  ...
  try {
    SystemOptionBean3 systemOptionBean3 = SystemOptionBean3(
    ...
    DataProvider?.setSystemOptionBean3(systemOptionBean3);
  } catch (e) {
    // 处理异常的代码
    print('Error: $e');
  }
...
void getValue() {
  String message = (DataProvider?.getSystemOptionBean3() as SystemOptionBean3).toString();
