...
import 'package:CEP/beans/system_option_new_e_bean.dart';
...
class SysOptionSettingPage6 extends StatelessWidget {
  ...
  const SysOptionSettingPage6({super.key});
...
class _MySysOptionSettingState extends State<MySysOptionSettingPage> {
  final List<String> options= transportClinker;
  @override
  ...
  void initState() {
    ...
    systemOptionBean5  =
        DataProvider.getInstance()?.systemOptionBean5;
    if(systemOptionBean5 != null){
      _controlers[0].text =
      systemOptionBean5 ?.ruyao_kw.toString() as String;
      _controlers[1].text =
      systemOptionBean5 ?.ruyao_product.toString() as String;
      _controlers[2].text =
      systemOptionBean5 ?.pidai_kw.toString() as String;
      _controlers[3].text =
      systemOptionBean5 ?.pidai_product.toString() as String;
    }
  }
...
void save() {
  ...
  try {
    SystemOptionBean5 systemOptionBean5 = SystemOptionBean5(
    ...
    DataProvider?.setSystemOptionBean5(systemOptionBean5);
  } catch (e) {
    // 处理异常的代码
    print('Error: $e');
  }
...
void getValue() {
  String message = (DataProvider?.getSystemOptionBean5() as SystemOptionBean5).toString();
